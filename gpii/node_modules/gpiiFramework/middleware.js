...
(function () {
    ...
    fluid.defaults("gpii.middleware", {
        ...
        invokers: {
            ...
            useMiddleware: {
                ...
                args: ["{gpii.server}.server", "{that}.options.path", "{that}.resolveEventName"]
            },
            handle: {
    ...
    gpii.middleware.useMiddleware = function (server, path, resolveEventName) {
        var args = [function (req, res, next) {
        ...
        members: {
            path: {
                expander: {
                    ...
                    args: "{that}.options.staticPath"
                }
            }
        },
        staticPath: "{gpii.app}.options.static",
        invokers: {
            handle: {
